...
const FName FN2CToolbarCommand::CommandName_CreateCodexHandoff = TEXT("NodeToCode_CreateCodexHandoff");
...
const FText FN2CToolbarCommand::CommandLabel_CreateCodexHandoff = NSLOCTEXT("NodeToCode", "CreateCodexHandoff", "Create Local Codex Handoff");
...
const FText FN2CToolbarCommand::CommandTooltip_CreateCodexHandoff = NSLOCTEXT("NodeToCode", "CreateCodexHandoffTooltip", "Create a local Codex handoff package without calling any cloud provider");
...
void FN2CToolbarCommand::RegisterCommands()
{
    ...
    UI_COMMAND(
        CreateCodexHandoffCommand,
        "Create Local Codex Handoff",
        "Create a local Blueprint JSON handoff package for Codex without sending any cloud request.",
        EUserInterfaceActionType::Button,
        FInputChord()
    );
